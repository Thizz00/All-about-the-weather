...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setStyleSheet("border-image: url(/static/max-bender-VmX3vmBecFE-unsplash.jpg);")
...
"}")
        ...
        self.pushButton.clicked.connect(lambda:self.Find_Weather_for_City())
...
"}")
    ...
    def Find_Weather_for_City(self):
            import requests
